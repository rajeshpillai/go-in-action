...
func main () {
  ...
  // Use short declclaration to create variable with type int and a value of 3 
  i := 3 

  // Use a type conversion if you want to use short declaration with other int types
  u := uint64(4) 
